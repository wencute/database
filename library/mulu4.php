...
{  
  ...
  <div class="tyg-div-denglv">
   ...
   <form name="myForm" action="xiangxi1.php" method="post" >
...
$sql = "SELECT name,writer,infromation,COUNT(sum) as count1,SUM(rest_num) as count2, yuyue FROM `book` WHERE writer LIKE '$writer%' group by name   ";
