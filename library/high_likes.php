...
$id=$_POST["id"];
$_SESSION['book_id']=$id;
$sql = "SELECT * FROM `book` WHERE likes = (SELECT MAX(likes) FROM book)  ";
...
<div class="container">
	...
	<div id="header" class="row">
		...
		<div class="col-sm-10">
			...
			<div id="login_click" style="margin:40px 250px;">  
		  <a id="btlogin" style=" background:#01B468" onclick="window.open('jieyue.php')">借阅记录</a>
			
		  <a id="btlogin" style=" background:#01B468" onclick="window.open('delete_book.php')">删除</a>
			...
			<div class="row">
				<div class="col-sm-4">
					<ul class="list-unstyled">
						<li><a href="">图书编号：<?php echo"$row[0]";?></a>
						</li>
						<li><a href=""><?php echo"$row[3]";?></a>
						</li>
						<li><a href="">书籍类别：<?php echo"$row[6]";?></a>
						</li>
						<li><a href="">图书所属：<?php echo"$a";?></a>
						</li>
					</ul>
				...
				<div class="col-sm-4">
					<ul class="list-unstyled">
						<li><a href="">总数：<?php echo"$row[4]";?></a>
						</li>
						<li><a href="">剩余数量：<?php echo"$row[5]";?></a>
						</li>
						<li><a href="">所属馆区编号：<?php echo"$row[8]";?></a>
						</li>
						<li><a href="">收藏量：<?php echo"$c";?></a>
						</li>
					</ul>
				...
				<div class="col-sm-4">
					<ul class="list-unstyled">
						<li><a href="">所属楼层：<?php echo"$row[7]";?></a>
						</li>
						<li><a href="">出版时间：<?php echo"$row[10]";?></a>
						</li>
						<li><a href="">￥<?php echo"$row[11]";?></a>
						</li>
						<li><a href="">评论量：<?php echo"$b";?></a>
						</li>
					</ul>
